  ...
  if (category === 'Design & UX') {
    return (
      <svg viewBox="0 0 72 72" {...props}>
        ...
        <circle cx="36" cy="6" r="2.5" fill="var(--color-text)" />
        <circle cx="6" cy="36" r="2.5" fill="var(--color-text)" />
        <circle cx="66" cy="36" r="2.5" fill="var(--color-text)" />
        <circle cx="36" cy="38" r="3" fill="var(--color-text)" />
      </svg>
    );
  }
  return (
          ...
          {skills.map((skill, idx) => (
            <div
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = '0 4px 24px 0 rgba(34,34,59,0.08)';
              }}
              onMouseLeave={e => {
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 relative z-10">
                ...
                <h3 className="font-semibold text-sm" style={{ color: 'var(--color-text)' }}>{skill.category}</h3>
              </div>
